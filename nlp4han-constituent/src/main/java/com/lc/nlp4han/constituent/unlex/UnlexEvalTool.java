...
/**
 * @author 作者
 * @version 创建时间：2018年10月22日 上午3:29:33 类说明
 */
public class UnlexEvalTool
{
	public static void eval() throws IOException
	{
		Grammar g = GrammarExtractorTool.generateInitialGrammar(true, Lexicon.DEFAULT_RAREWORD_THRESHOLD,
				"C:\\Users\\hp\\Desktop\\train.utf-8.txt");
		...
		ObjectStream<String> treeStream = new PlainTextByTreeStream(
				new FileInputStreamFactory(new File("C:\\Users\\hp\\Desktop\\goldtree.txt")), "gbk");
