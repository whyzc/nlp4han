...
public class CrossValidator
{
	 ...
	 * @throws IOException
	 */
	public void evaluate(ObjectStream<ConstituentTree> sampleStream, int nFolds,ConstituentMeasure measure) throws IOException{
		
		CrossValidationPartitioner<ConstituentTree> partitioner = new CrossValidationPartitioner<ConstituentTree>(sampleStream, nFolds);
		...
		while(partitioner.hasNext()){
            ...
            CKYAnalysisEvaluator evaluator=new CKYAnalysisEvaluator(cky);
