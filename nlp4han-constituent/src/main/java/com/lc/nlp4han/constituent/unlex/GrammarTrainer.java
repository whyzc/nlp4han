...
//
// public static Grammar train(Grammar g, TreeBank treeBank, int SMCycle, double
// mergeRate, int EMIterations,
// double smooth)
// {
...
// {
// double subTagCount = ruleCounter.sameParentRulesCounter.get((short)
// tag)[subT];
// double subTagUNKCount = ruleCounter.sameTagToUNKCounter.get((short)
// tag)[subT];
// subTag2UNKScores[tag][subT] = subTagUNKCount / subTagCount;
// System.out.println(g.symbolStrValue((short) tag) + "_" + subT + " " +
// subTagUNKCount / subTagCount);
// }
// else
// {
