...
public class PosChunkAnalysisContextGeneratorConf implements ChunkAnalysisContextGenerator
{
	...
	public PosChunkAnalysisContextGeneratorConf() throws IOException
	{
		...
		InputStream featureStream = PosChunkAnalysisContextGeneratorConf.class.getClassLoader()
	...
	public String toString()
	{
		return "ChunkAnalysisContextGenratorConf{" + "w_2Set=" + w_2Set + ", w_1Set=" + w_1Set + ", w0Set=" + w0Set
				+ ", w1Set=" + w1Set + ", w2Set=" + w2Set + ", af0Set=" + af0Set + ", pf0Set=" + pf0Set + ", p_2Set="
				+ p_2Set + ", p_1Set=" + p_1Set + ", c_2Set=" + c_2Set + ", c_1Set=" + c_1Set + ", w_2w_1Set="
				+ w_2w_1Set + ", w_1w0Set=" + w_1w0Set + ", w0w1Set=" + w0w1Set + ", w1w2Set=" + w1w2Set + ", w_1w1Set="
				+ w_1w1Set + ", w_2w_1w0Set=" + w_2w_1w0Set + ", w_1w0w1Set=" + w_1w0w1Set + ", w0w1w2Set=" + w0w1w2Set
				+ ", p_2p_1Set=" + p_2p_1Set + ", c_2c_1Set=" + c_2c_1Set + ", w0p_1Set=" + w0p_1Set + ", w_1p_1Set="
				+ w_1p_1Set + ", w0p_2Set=" + w0p_2Set + ", w_1w0p_1Set=" + w_1w0p_1Set + '}';
	}
}
