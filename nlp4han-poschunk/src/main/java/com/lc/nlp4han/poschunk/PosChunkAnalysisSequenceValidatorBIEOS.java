 ...
 */
public class PosChunkAnalysisSequenceValidatorBIEOS implements SequenceValidator<String>
{

	public PosChunkAnalysisSequenceValidatorBIEOS()
	{
