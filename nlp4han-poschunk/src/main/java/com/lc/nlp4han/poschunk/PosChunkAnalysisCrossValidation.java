...
public class PosChunkAnalysisCrossValidation
{
			...
			SequenceValidator<String> sequenceValidator) throws IOException
	{
		...
		while (partitioner.hasNext())
		{
			...
			String label = ((PosChunkAnalysisSampleStream) sampleStream).getScheme();
			...
			PosChunkAnalysisEvaluator evaluator = new PosChunkAnalysisEvaluator(
					new PosChunkAnalysisWordME(model, sequenceValidator, contextGenerator, label), measure);
