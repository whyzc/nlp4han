...
/**
 * 基于词的词性标注和组块分析的BIEOS样本解析（组块最小长度为1）
 */
public class PosChunkSampleParserBIEOS extends AbstractChunkSampleParser
{
	 ...
	 * 构造方法
	 */
	public PosChunkSampleParserBIEOS()
	{
		this.scheme = "BIEOS";
	}
	...
	public AbstractChunkAnalysisSample parse(String sentence)
	{
		...
		PosChunkAnalysisSample sample = new PosChunkAnalysisSample(words, posChunkTags);
