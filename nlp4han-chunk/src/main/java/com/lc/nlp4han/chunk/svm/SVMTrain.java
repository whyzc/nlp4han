...
public class SVMTrain extends svm_train{
	...
	public static final String OPTIONS = "-model model_file : set model file path\n"
			...
			+"-l lower : x scaling lower limit \n"
			+"-u upper : x scaling upper limit \n"
	...
	{
		SVMTrain.usage = usage;
	}


	public svm_model run(String argv[], String[] standardInput, boolean serialization, ScaleInfo scaleInfo) throws IOException
	{
...
//	{
//		return run(argv, standardInput, true, SVMStandardInput.getScaleInfo());
//	} TODO
